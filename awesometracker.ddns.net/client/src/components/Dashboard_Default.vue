	...
	<div>
		...
		<div v-if="ready == true">
			...
			<div class="row justify-content-center">
				...
				<Card v-bind:data="apps.length" title="Total apps"/>
				...
				<Card v-bind:data="$functions.todayApps(apps)" title="Today apps"/>
			...
			<div class="row mt-3 justify-content-around">
				...
				<Table v-bind:data="users" v-bind:title="'Last 10 users'" v-bind:rows="10" v-bind:type="'users'" v-bind:direction="'reverse'" v-if="users.length != 0"/>
				...
				<Table v-bind:data="apps" v-bind:title="'Last 10 apps'" v-bind:rows="10" v-bind:type="'apps'" v-bind:direction="'reverse'" v-if="apps.length != 0"/>
				<Table v-bind:data="apiCalls" v-bind:title="'Last 10 API calls'" v-bind:rows="10" v-bind:type="'apiCalls'" v-bind:direction="'reverse'" v-if="apiCalls.length != 0"/>
...
<script>
	...
	export default {
		...
		async created() {
			...
			result = await Axios.get(`https://awesometracker.ddns.net/dashboard/data/5?orderBy=users.code`);
